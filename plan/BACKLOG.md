...
| M-07 | Sincronização (Cold Start): Tela de Setup com "Criar novo" (usando FilePicker flexível para nome do arquivo, ex: `.json`) ou "Abrir". Salvar FileHandle no IndexedDB. | crítica    | aberto    |
